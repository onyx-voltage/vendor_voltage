...
VOLTAGE_VERSION := $(VOLTAGEVERSION)-$(VOLTAGE_BUILD)-$(VOLTAGE_BUILD_DATE)-VANILLA-$(VOLTAGE_BUILD_TYPE)
ifeq ($(WITH_GMS), true)
VOLTAGE_VERSION := $(VOLTAGEVERSION)-$(VOLTAGE_BUILD)-$(VOLTAGE_BUILD_DATE)-GAPPS-$(VOLTAGE_BUILD_TYPE)
endif
